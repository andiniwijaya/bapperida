...
@section('content')
    <div class="mx-auto max-w-7xl">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold">Tambah Arsip Surat Keluar</h1>
                <p class="ds-subheading">Tambahkan arsip surat keluar baru berdasarkan registrasi penomoran.</p>
            </div>
        ...
        <x-crud.form-card
            ...
            description="Pilih registrasi penomoran dan lengkapi lampiran surat."
            enctype="multipart/form-data"
        >
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 lg:col-span-6">
                    <x-select
                        id="letter_number_registration_id"
                        name="letter_number_registration_id"
                        label="Registrasi Penomoran"
                        placeholder="Pilih registrasi penomoran..."
                        searchable
                        autofocus
                        required
                    />
    ...
    @vite('resources/js/modules/outgoing-letter/create.js')
@endsection
